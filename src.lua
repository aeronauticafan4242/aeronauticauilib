...
function Library:create(options)
	...
	neonGradient.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0.00, NEON[1]),
		ColorSequenceKeypoint.new(0.30, NEON[3]),
		ColorSequenceKeypoint.new(0.55, NEON[4]),
		ColorSequenceKeypoint.new(0.80, NEON[2]),
		ColorSequenceKeypoint.new(1.00, NEON[1])
	})
	...
	do
		local FLAG_TEXTURES = {
			CN="95356188605201",IL="87178628307734",HK="81078025736597",AU="135837426211582",US="98549868754895",
			PL="108029915803248",ID="99034051326034",RU="71231411553592",NL="133008014492211",IT="95408702907643",
			DE="109120157295029",BE="128650969593502",ES="101688284436857",NO="121200030759992",LV="131623091910563",
			IS="131743194608145",CH="118649292849693",RO="82413235447979",RS="138761728406536",PT="137168686367362",
			SE="71371805621990",GB="116196579131433",VA="108026796604579",UA="94638529863776",SK="71151769954466",
			SM="95919382090064",SI="83958921283650",MT="134060629377315",MK="84925039600472",ME="79735766833469",
			MD="77152666033392",MC="137130708480574",LU="105215805793258",LT="90545077079583",LI="74626320276334",
			XK="95873237128590",JE="79467073038036",IM="117648625741399",IE="88141160813152",HU="97748697000227",
			GR="139942835703090",GI="132999655978164",GG="121387192170165",GE="121659908388622",FR="102779767020139",
			FO="122134382020360",FI="110772483009652",EE="100727414383014",DK="106774323775668",CZ="77382403470019",
			CY="127521439529470",HR="129888190594595",BY="117539061429656",BG="134326507611664",BA="113742079876993",
			AX="128887189780896",AT="94349632238142",AL="130824443298424",AD="105103950342219",PH="99305831773444",
			EU="94002829626770",
		}
		task.spawn(function()
			...
			local id = (ok and code) and FLAG_TEXTURES[code] or nil
			if id then
				-- id = textureID (не decal!) -> рендерится напрямую, как луна.
				pcall(function()
